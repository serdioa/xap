...
public class SpaceImpl extends AbstractService implements IRemoteSpace, IInternalRemoteJSpaceAdmin, DiscoveryListener,
    ...
    private void initSpaceConfig(SpaceConfig spaceConfig, SpaceConfigReader configReader, String schemaFilePath) {
        ...
        if (spaceConfig.isMvccEnabled()) {
            System.setProperty(SystemProperties.SPACE_RECOVERY_FILTER_AFTER_COPY,
                    String.valueOf(SystemProperties.getBoolean(SystemProperties.SPACE_RECOVERY_FILTER_AFTER_COPY, false))); // disable this optimization in mvcc
