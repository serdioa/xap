...
public class CopyChunks {
    ...
    public CopyChunksResponseInfo execute(SpaceImpl space, SpaceRequestInfo requestInfo) throws Exception { //todo- no use of return value
        int queueSize = 10000;
        int batchSize = 1000;
        int threadCount = 10;
        ...
        } catch (AutoGeneratedIdNotSupportedException e) {  //todo- is it recoverable? detailed message?
