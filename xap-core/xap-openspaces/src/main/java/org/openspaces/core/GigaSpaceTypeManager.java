...
public interface GigaSpaceTypeManager {
     ...
     * <p>Note: This API should use with caution and has some known limitations, and possibly more:
     * <ol>
     * <li> <b>Concrete types:</b> When a concrete type (POJO, scala case class, etc.) is unregistered, its Java
     * class is not unloaded from the server. This means you cannot register a modified version of that type.</li>
     * <li> <b>Subtypes:</b> A type with subtypes cannot be unregistered - you must first explicitly unregister all
     * subtypes</li>
     * <li> <b>Atomicity:</b> This operation is carried out across the cluster.
     * Consider using quiesce for atomicity and consistency</li>
     * </ol>
     * </p>
     *
