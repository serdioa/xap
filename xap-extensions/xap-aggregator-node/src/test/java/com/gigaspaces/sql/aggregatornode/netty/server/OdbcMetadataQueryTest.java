...
public class OdbcMetadataQueryTest extends AbstractServerTest {
    ...
    private static final String SELECT_TABLES = "" +
            "SELECT n.oid,c.relnamespace, c.oid from pg_catalog.pg_namespace n " +
            "INNER JOIN pg_catalog.pg_class c ON n.oid = c.relnamespace";
    private static final String SELECT_TABLES1 = "SELECT c.relnamespace, c.oid from pg_catalog.pg_class c";
    private static final String SELECT_TABLES2 = "SELECT n.oid from pg_catalog.pg_namespace n";

    private static final String SELECT_TABLESZ = "" +
            "select relname, nspname, relkind, relnamespace, n.oid " +
...
//            "and n.oid = relnamespace " +
    ...
    private static final String SELECT_TABLES_NO_FILTER = "select relname, relkind from pg_catalog.pg_class";
    private static final String SELECT_TABLES_NO_FILTER_1 = "select relname, relkind from pg_catalog.pg_class where relkind = 'r'";
    private static final String SELECT_TABLESZZZ = "select relname, relkind from pg_catalog.pg_class where relkind in ('r', 'v', 'm', 'f', 'p')";
...
//        checkQuery(SELECT_TABLES_NO_FILTER);
//        checkQuery(SELECT_TABLES_NO_FILTER_1);
//        checkQuery(SELECT_TABLES1);
//        checkQuery(SELECT_TABLES2);
