...
public enum PredefinedSystemMetrics implements TableColumnNames {
    ...
    SPACE_TIERED_STORAGE_WRITE_TP("space_tiered-storage-write-tp", Arrays.asList( TIME_COLUMN_NAME, PU_NAME_COLUMN_NAME ) ),
    SPACE_TIERED_STORAGE_READ_TP("space_tiered-storage-read-tp", Arrays.asList( TIME_COLUMN_NAME, PU_NAME_COLUMN_NAME ) ),
...
*/
    ...
    SPACE_DATA_TOTAL_READ_COUNT( "space_data_total-read-count", Arrays.asList( TIME_COLUMN_NAME, PU_INSTANCE_ID_COLUMN_NAME, SPACE_NAME_COLUMN_NAME, DATA_TYPE_NAME_COLUMN_NAME ) ),
    SPACE_DATA_RAM_READ_COUNT( "space_data_ram-read-count", Arrays.asList( TIME_COLUMN_NAME, PU_INSTANCE_ID_COLUMN_NAME, SPACE_NAME_COLUMN_NAME, DATA_TYPE_NAME_COLUMN_NAME ) ),
    SPACE_DISK_SIZE( "space_disk-size", Arrays.asList( TIME_COLUMN_NAME, PU_INSTANCE_ID_COLUMN_NAME, SPACE_NAME_COLUMN_NAME ) ),
